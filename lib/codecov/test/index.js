...
describe('Codecov', function() {
  ...
  it('should generate a negative message', function() {
    ...
    assert.equal(response.message, '[Coverage](https://codecov.io/github/owner/repo?ref=b955f16919680d33521da9b25213bb7b3ad20a5a) (master) `-1.2%`');
  ...
  it('should generate a neutral message', function() {
    ...
    assert.equal(response.message, '[Coverage](https://codecov.io/github/owner/repo?ref=b955f16919680d33521da9b25213bb7b3ad20a5a) (master) `+0.0%`');
    assert.equal(response.icon, 'smile');
    assert.equal(response.errorLevel, 'normal');
  });
  ...
  it('should generate a pr message', function() {
    ...
    assert.equal(response.message, '[Coverage](https://codecov.io/github/owner/repo?ref=b955f16919680d33521da9b25213bb7b3ad20a5a) (#1) `+0.0%`');
    assert.equal(response.icon, 'smile');
    assert.equal(response.errorLevel, 'normal');
  });
